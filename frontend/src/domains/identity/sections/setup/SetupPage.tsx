  ...
  if (identity.configured) {
    return (
      <section className="dccard auth-card">
        ...
        <a className="dcbtn primary auth-submit" href="/login">
          Go to sign in
        </a>
      </section>
    )
  ...
  return (
    <section className="dccard auth-card">
      ...
      <p className="auth-sub">
        Create the admin account before anything else is reachable. There is no default password —
        you choose one now.
      </p>
      ...
      <form action="/auth/setup" className="auth-form" method="post">
        ...
        <label className="dcfield">
          ...
          <input
            className="dcinput"
            name="displayName"
            placeholder="Optional — defaults to the email's local part"
            type="text"
          />
        </label>
        <label className="dcfield">
          <span>
            Password <span className="required">*</span> <code>min 12 characters</code>
          </span>
          <input
        ...
        <div className="auth-hint">
          Avoid common or reused passwords — this account can manage the whole workspace.
        </div>
      </form>
    </section>
  )
