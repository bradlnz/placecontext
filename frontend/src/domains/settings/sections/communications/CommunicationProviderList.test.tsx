...
export const providerFixture: CommunicationProvider = {
...
describe('CommunicationProviderList', () => {
  it('renders provider flags and asynchronously opens test delivery controls', async () => {
    ...
    expect(screen.getByText('2FA')).toBeVisible()
    await user.click(screen.getByRole('button', { name: 'Test' }))
    expect(screen.getByLabelText('Test recipient')).toHaveAttribute(
      'placeholder',
