...
the project manifests (`src/*/*.csproj`) — those files are authoritative.
...
| [MLX LM](https://github.com/ml-explore/mlx-lm) / [PyTorch](https://github.com/pytorch/pytorch) (local AI worker backends) | MIT / BSD-3-Clause |
