...
public sealed class DesktopApiAuthorizationTests
{
    ...
    [InlineData(nameof(DesktopApiController.GetJobDefinition), Permission.JobsView)]
    [InlineData(nameof(DesktopApiController.CreateJobDefinition), Permission.JobsEdit)]
    [InlineData(nameof(DesktopApiController.UpdateJobDefinition), Permission.JobsEdit)]
