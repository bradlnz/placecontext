...
public sealed class ParameterPromptStateTests
{
    ...
    public void ToJobPayload_uses_bare_param_names()
    {
        ...
        prompt.Reset(new Dictionary<string, string>
        {
            ["address"] = "123 Main",
            ["limit"] = "10",
        });
    ...
    public void ToStepPayloadOverrides_groups_by_step_with_bare_param_names()
    {
        ...
        {
            (0, Job("a", new JobParameterDto("address"), new JobParameterDto("city", Required: false))),
    ...
    private static JobView Job(string name, params JobParameterDto[] parameters) => new(
        Id: Guid.NewGuid(),
