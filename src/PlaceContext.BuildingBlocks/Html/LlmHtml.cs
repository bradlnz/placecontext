...
/// <summary>Shared helpers for producing safe, portal-ready HTML documents.</summary>
public static class LlmHtml
{
    private const string ChartThemeCss =
        ...
        "html,body{background:var(--pc-bg)!important;color:var(--pc-ink)!important;margin:0!important;font-family:'Geist',ui-sans-serif,system-ui,-apple-system,sans-serif!important}" +
        "body{padding:16px 18px!important;box-sizing:border-box}h1,h2,h3,h4{color:var(--pc-ink)!important;font-weight:600;line-height:1.25}" +
        "h1{font-size:18px!important;margin:0 0 12px!important}h2{font-size:15px!important}h3{font-size:12px!important;color:var(--pc-ink2)!important}" +
        "p,li,figcaption,.meta{color:var(--pc-ink2)!important}svg{max-width:100%;height:auto}svg text{fill:var(--pc-ink)!important;font-family:'Geist',ui-sans-serif,system-ui,sans-serif!important}" +
        "table{border-collapse:collapse;width:100%;font-size:12.5px}th,td{border:1px solid var(--pc-border)!important;padding:6px 9px;text-align:left;color:var(--pc-ink2)!important}" +
        "th{background:var(--pc-surface)!important;color:var(--pc-ink)!important;font-weight:600}a{color:var(--pc-brand)!important}code,pre{font-family:'Geist Mono',ui-monospace,monospace!important}" +
        "pre{background:var(--pc-surface)!important;border:1px solid var(--pc-border)!important;border-radius:8px;padding:10px;overflow:auto;color:var(--pc-ink2)!important}</style>";
