...
/// <summary>Search runtime adapter for the shared data-at-rest contract.</summary>
public sealed class SearchDataProtectionEncryptor : IDataEncryptor
{
    ...
    public SearchDataProtectionEncryptor(IDataProtectionProvider provider)
        => _provider = provider;
