...
On the left side, a detailed existing Queenslander-style house (cream weatherboard, corrugated metal roof, wrap-around veranda) sits on a fenced lot labeled "{lot1_label}: {lot1_area}". Behind it, a newly created access handle leads to a rear lot. On the right, the proposed new dwelling is a premium real-estate exterior photograph of a striking modern dual-occupancy duplex, two attached contemporary two-storey homes, matte white facade with charcoal accents and black-framed windows, clean architectural lines, wide concrete driveway, manicured surroundings, bright soft overcast daylight, slightly low confident hero angle, sharp professional architectural photography, sophisticated and high-end, subject in upper two-thirds, calmer foreground, no text, no logos, no watermarks. This dwelling is shown on a lot labeled "{lot2_label}: {lot2_area}". The entire original property is outlined with a precise red boundary line. Manicured hedges, varied miniature trees, and realistic grass detail the landscaping.
