...
public static class ChartHelper
{
    ...
    public static string CanvasId(string slot, string prefix = "pcchart-")
        => prefix + Convert.ToHexString(System.Security.Cryptography.MD5.HashData(
    ...
    public static IReadOnlyList<ProjectChartView> SqlCharts(IReadOnlyList<ProjectChartView> charts)
        => charts.Where(c => c.TableName.StartsWith("sql:", StringComparison.Ordinal)
