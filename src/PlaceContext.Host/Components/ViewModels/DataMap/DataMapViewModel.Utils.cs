...
public sealed partial class DataMapViewModel
{
    ...
    {
        System.Text.Json.JsonValueKind.Number => v.TryGetInt64(out _) ? DataColumnTypes.Bigint : DataColumnTypes.Numeric,
        System.Text.Json.JsonValueKind.True or System.Text.Json.JsonValueKind.False => DataColumnTypes.Boolean,
        System.Text.Json.JsonValueKind.Object or System.Text.Json.JsonValueKind.Array => DataColumnTypes.Jsonb,
        System.Text.Json.JsonValueKind.String when DateTimeOffset.TryParse(v.GetString(), out _) => DataColumnTypes.Timestamptz,
