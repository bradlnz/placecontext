...
/// <see cref="WorkloadDependencyRecipe.InstallTemplate"/> the shard would, so the tar mirrors a shard's /work). A
/// warmed shard still applies <see cref="WorkloadDependencyRecipe.EnvTemplate"/> (PYTHONPATH etc. find the baked
/// deps) but skips <see cref="WorkloadDependencyRecipe.InstallTemplate"/> when the cache marker is present. Any
...
public static class WorkloadDependencies
{
    ...
    private static readonly Dictionary<string, WorkloadDependencyRecipe> Recipes = new(StringComparer.OrdinalIgnoreCase)
    {
        ["python"] = new(
    ...
    public static WorkloadDependencyRecipe? For(string? runtimeId, IReadOnlyList<(string Path, string Content)>? codeFiles) =>
    ...
    public static IReadOnlyList<(string Path, string Content)> ManifestFiles(
        WorkloadDependencyRecipe recipe, IReadOnlyList<(string Path, string Content)> codeFiles)
    {
    ...
    /// </summary>
    public static string BakeKey(string runtimeId, string baseImage, WorkloadDependencyRecipe recipe,
    ...
    /// </summary>
    public static string Dockerfile(string baseImage, WorkloadDependencyRecipe recipe,
        IReadOnlyList<(string Path, string Content)> codeFiles)
    {
    ...
    /// </summary>
    public static string[] WrapDockerCommand(WorkloadDependencyRecipe recipe, string[] cmd)
    {
    ...
    /// </summary>
    public static string ShellPreamble(WorkloadDependencyRecipe recipe)
    {
