...
public sealed class KubernetesWorkloadRunner : IWorkloadRunner
{
    ...
    private Task<string?> EnsureWarmCacheAsync(string ns, Kubernetes client, string runtimeId, string baseImage,
        WorkloadDependencyRecipe recipe, WorkloadRunRequest request, CancellationToken ct)
    {
    ...
    private async Task<string?> BakeAsync(string ns, Kubernetes client, string key, string runtimeId,
        string baseImage, WorkloadDependencyRecipe recipe, WorkloadRunRequest request, CancellationToken ct)
    {
        var store = _store!;
    ...
    /// </summary>
    internal static string BuildBakeScript(WorkloadDependencyRecipe recipe,
