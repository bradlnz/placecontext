...
/// <summary>Jobs runtime adapter for the shared data-at-rest contract.</summary>
public sealed class JobsDataProtectionEncryptor : IDataEncryptor
{
    ...
    public JobsDataProtectionEncryptor(IDataProtectionProvider provider) => _provider = provider;
