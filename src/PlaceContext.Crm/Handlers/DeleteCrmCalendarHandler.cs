...
{
    private readonly ICrmCalendarRepository _calendars; private readonly ICrmAppointmentRepository _appointments; private readonly ICrmUnitOfWork _uow;
    public DeleteCrmCalendarHandler(ICrmCalendarRepository calendars, ICrmAppointmentRepository appointments, ICrmUnitOfWork uow) => (_calendars, _appointments, _uow) = (calendars, appointments, uow);
