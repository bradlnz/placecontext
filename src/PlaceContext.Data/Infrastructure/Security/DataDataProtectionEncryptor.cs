...
/// <summary>Data runtime adapter for the shared data-at-rest contract.</summary>
public sealed class DataDataProtectionEncryptor : IDataEncryptor
{
    ...
    public DataDataProtectionEncryptor(IDataProtectionProvider provider)
        => _provider = provider;
