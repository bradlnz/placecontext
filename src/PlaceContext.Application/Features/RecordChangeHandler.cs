...
public sealed class RecordChangeHandler : ICommandHandler<RecordChangeCommand, ChangeRecordView>
{
    ...
    public async Task<ChangeRecordView> HandleAsync(RecordChangeCommand command, CancellationToken ct = default)
    {
        ...
        var record = ledger.Append(
            ...
            DebtDelta.From(command.DebtResolved, command.DebtIntroduced),
            new ChangeVerification(command.ArchitectureReviewerRun, command.LiveVerified),
