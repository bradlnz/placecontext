...
/// <summary>Artifacts runtime adapter for the shared data-at-rest contract.</summary>
public sealed class ArtifactDataProtectionEncryptor : IDataEncryptor
{
    ...
    public ArtifactDataProtectionEncryptor(IDataProtectionProvider provider)
        => _provider = provider;
