...
namespace PlaceContext.Artifacts.Infrastructure.Artifacts;
...
public sealed class ArtifactShareTokenService : IArtifactShareTokenService
{
    ...
    private readonly ArtifactsDbContext _db;
    private readonly IClock _clock;

    public ArtifactShareTokenService(ArtifactsDbContext db, IClock clock)
        => (_db, _clock) = (db, clock);
